...
<form method="POST" action="{{ route('journals.update', $journal->id) }}">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <input type="text" name="authors" class="form-control" value="{{ old('authors', $journal->authors) }}">
        </div>
        <div class="col-md-12 mb-3">
        ...
        <div class="col-md-6 mb-3">
            <label>Pages</label>
            <input type="text" name="pages" class="form-control" value="{{ old('pages', $journal->pages) }}">
        </div>
        <div class="col-md-6 mb-3">
            <label>Publication Date</label>
            <input type="text" name="publication_date" class="form-control" value="{{ old('publication_date', $journal->publication_date) }}">
        </div>
        <div class="col-md-6 mb-3">
            <label>ISSN</label>
            <input type="text" name="issn" class="form-control" value="{{ old('issn', $journal->issn) }}">
        </div>
        <div class="col-md-6 mb-3">
            <label>Link</label>
        ...
        <div class="col-md-12 mb-3">
            <label>Keyword:</label>
            <input type="text" name="keyword" class="form-control" value="{{ old('keyword', $journal->keyword) }}">
        </div>
        <div class="col-md-12 mb-3">
            <label>Note:</label>
