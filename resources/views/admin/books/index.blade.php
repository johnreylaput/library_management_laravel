                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <form action="{{ route('books.destroy', $book->id) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="dropdown-item text-danger" onclick="return confirm(@if(Auth::check() && Auth::user()->role === 'Working.Student')'Submit a deletion request for this book? maria.librarian will review it.'@else'Move this book to Recently Deleted? It can be restored later.'@endif)">
